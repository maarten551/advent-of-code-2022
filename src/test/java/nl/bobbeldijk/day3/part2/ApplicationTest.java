...
class ApplicationTest {
    ...
    void calculateAnswerTest() throws AnswerNotFoundException {
        ...
        assertEquals(70, application.calculateAnswer(testInput));
    }

    @ParameterizedTest
    @CsvFileSource(resources = "/day-3/calculateAnswerMultipleLinesTest.csv")
    void calculateAnswerSingleLinesTest(String line, Integer expectedValue) throws AnswerNotFoundException {
        assertEquals(expectedValue, application.calculateAnswer(List.of(line.split(" "))));
    }
}